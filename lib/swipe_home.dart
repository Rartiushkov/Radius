...
import 'user_account_screen.dart'; // Если профиль свайпом вверх — оставим
...
class _SwipeHomeState extends State<SwipeHome> {
  ...
  void _openProfile() {
    showModalBottomSheet(
      ...
      builder: (context) => const UserAccountScreen(), // или другой экран
    );
  }
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("Swipe up to Profile",
